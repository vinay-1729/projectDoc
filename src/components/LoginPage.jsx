...
export default function LoginPage() {
  return (
      <div className="flex mx-48 my-16 bg-teal-200 h-[576px] shadow-lg">
        <div className="w-2/6">
        </div>
        <div className="w-4/6 bg-white rounded-tl-[50px] rounded-bl-[50px] border-2	">
          ...
          <div className="flex mt-2 justify-items-center">
            ...
            <div className="mb-6 md:flex md:justify-between">
                <input type="email" placeholder="Email Address" className="border-b-2 rounded text-sm py-3 px-2 w-full" />
            </div>
            <div className="mb-5 md:flex md:justify-between">
                <input type="password" placeholder="Password" className="border-b-2  rounded text-sm py-3 px-2 w-full" />
            </div>
            </form>  
            <div className="flex-row-reverse text-right pr-3 text-gray-500">
                <a href="#" className="text-teal-400">Forgot Password?</a>
            </div>
            <button role="button" className="bg-teal-500 py-2 px-2 w-full mx-3 mt-2 rounded-[20px]">
